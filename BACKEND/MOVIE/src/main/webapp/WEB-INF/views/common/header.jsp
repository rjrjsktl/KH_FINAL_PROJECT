...
<%-- <link rel="stylesheet" href="${contextPath}/resources/css/login/modalcss.css"> --%>
<header>
	<section>
			...
			<c:if test="${not empty loginUser.userNo}">
				<ul>
					...
					<li><a href="${contextPath}/user/logout"> <span><img
								src="${contextPath}/resources/images/headerPng/logout1.png"	alt=""></span>
							 <span>로그아웃</span>
					</a></li>
	...
	<nav>
		<div>
			<ul>
				<li class="navBar"><a
					href="${contextPath}/movieList/detail_List">영화</a>
				...
				<li class="navBar"><a
					href="${contextPath}/theater/normalTheater">상영관</a>
					<ul class="menuBar" style="display: none">
						<!-- 지역별로 이동 -->
				...
				<li class="navBar"><a
					href="${contextPath}/eventList/detail_List">이벤트</a>
					<ul class="menuBar" style="display: none">
