                        ...
                        <section>
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li><a href="${contextPath}/helpDesk/helpDesk_term">이용약관</a></li><span>|</span>
                                    <li><a href="${contextPath}/helpDesk/helpDesk_information">개인정보처리방침</a></li><span>|</span>
                                    <li><a href="${contextPath}/helpDesk/helpDesk_criteria">편성기준</a></li>
                                </ul>
