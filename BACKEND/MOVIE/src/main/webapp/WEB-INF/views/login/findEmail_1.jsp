...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/login/findEmail_1.css">
            ...
            <div>
                <div>
                    ...
                    <div>
                        ...
                        <div>
                            <p>아이디 찾기</p>
                            <p>아이디의 이름과 전화번호를 기입해주세요</p>
                        </div>

                        <!-- form -->
                        <div>
                            <form action="#" method="POST" onsubmit="return findId_1_Validate()">
                                <div>
                                    <div>
                                        <div>
