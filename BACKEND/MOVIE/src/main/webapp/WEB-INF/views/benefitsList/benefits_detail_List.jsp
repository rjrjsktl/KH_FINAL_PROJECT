								...
								<div>
									<ol>
										<c:forEach var="benefits" items="${getBenefitsList['getBenefitsList']}" varStatus="status">
											<c:choose>
												<c:when test="${benefits['benefitsStatus'] ne 'N'}">
													<li>
														<div>
															<input type="hidden" class="benfitsNo" value="${benefits['benefitsNo']}" />
															<span class="wordOuter"></span>
															<a href="${contextPath}/benefitsList/benefits_detail_List/introduce/${benefits['benefitsNo']}">
																<img src="${benefits['benefitsImg']}" class="target1">
															</a>
														</div>

														<div>
															<a class="target1" href="${contextPath}/benefitsList/benefits_detail_List/introduce/${benefits['benefitsNo']}">
