                    ...
                    <div class="cont-wrap">
                        <div class="list_wrap">
                            <ul class="area-wrap">
                                ...
                                <li class="area-name">
                                    <span class="location yellowCol">서울</span>
            ...
            <span>극장 공지사항</span>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>[서울영화관]</td>
                            <td>내용이 이렇게나 긴데 일립시스가 필요할까 없을거같은데.. 그칭?</td>
                            <td>2023.06.05</td>
                        </tr>
                        <tr>
                            <td>[부산영화관]</td>
                            <td>내용이 이렇게나 긴데 일립시스가 필요할까 없을거같은데..</td>
                            <td>2023.06.05</td>
                        </tr>
                        <tr>
                            <td>[속초영화관]</td>
