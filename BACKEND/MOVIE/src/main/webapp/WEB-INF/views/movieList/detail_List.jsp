												...
												<c:when test="${movie['movieSt'] ne 'N'}">
													<li>
														...
														<div>
															...
															<div>
																<p class="textSize">
																	예매율&nbsp<span><span class="revlikeVal">${bookPercent[status.index]}</span></span>%
																</p>
																<p class="textSize">
																	개봉&nbsp<span>${movie['movieOpen']}</span>
																</p>
															</div>
														</div>
