            ...
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                <%@ page session="false" %>
                    ...
                    <head>
                        ...
                        <title>이미지 등록 테스트</title>

                        <link rel="stylesheet" href="${contextPath}/resources/css/manager/manager_test.css">
                    ...
                    <body class="dark light">
                        ...
                        <script src="${contextPath}/resources/js/manager/manager_test.js"></script>
