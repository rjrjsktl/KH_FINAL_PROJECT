...
<link rel="stylesheet"
	href="${contextPath}/resources/css/manager/managerPage.css">
<link rel="stylesheet"
						...
						<div class="left_Inner_Contents algin_Left">
							<div class="inner_Top">
								<span class="inner_Top_Text">상영중인 영화</span> <a
									href="${contextPath}/manager/play_list" class="movie_more">더보기</a>
							</div>
							<div class="inner_Top_Content">
								<div class="noticeTable">
									<table class="tableWrapper">
						...
						<div class="left_Inner_Contents">
							<div class="inner_Top">
								<span class="inner_Top_Text">공지사항</span> <a
									href="${contextPath}/manager/notice_list" class="notice_more">더보기</a>
							</div>
							<div class="inner_Top_Content">
								<div class="noticeTable">
									<table class="tableWrapper">
							...
							<ul id="managerMemo" class="managerMemo">
								...
								<li id="memoList" class="memoList"><textarea id="viewMemo"
									...
									<button type="button" id="dltbtn" class="dltbtn" name="momoNo"
										value="" onclick="delMemo()">삭제</button></li>
							</ul>
						</div>
					</div>
				</div>
