                    ...
                    <div class="content-wrap">
                        ...
                        <div class="notice-contents content_inner">
                            <table class="innerTable">
                                <tr>
                                    <th>제목</th>
                                    <td><input id="titleInput" type="text" placeholder=" 제목을 입력해 주세요."></td>
                                </tr>
                                <tr>
                                    <th>물품</th>
                                    <td><input id="lostItem" type="text" placeholder=" 잃어버린 물품에 대해 입력해 주세요."></td>
                                </tr>
                                <tr>
                                    <th>위치</th>
                                    <td><input  id="lostArea" type="text" placeholder=" 상세한 위치를 입력해 주세요."></td>
                                </tr>
                                <tr>
                                    <th>날짜</th>
                                    <td><input id="lostDate" type="date" placeholder=" 잃어버린 날짜를 입력해 주세요." class="dateBtn"
                                            onfocus="this.showPicker()"></td>
                                </tr>
                                <tr>
                                    <th>첨부파일</th>
                                    <td><input  id="lostFile" type="file" multiple class="align_File"></td>
                                </tr>
                            </table>
                        </div>
