...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/resources/css/myPage/myPage_home.css">
                        ...
                        <div>
                            <div class="notice-content-wrap">
                                ...
                                <div class="cont-search-wrap">
                                    ...
                                    <sapn>${loginUser.userNick}</sapn><span>님 환영합니다.</span>
                            ...
                            <div class="new-wrap">
                                ...
                                <div>
                                    <a href="#"><img src="../../images/noticePng/notice01.png" alt=""></a>
                                    <a href="">
                                ...
                                <div>
                                    <a href="#"><img src="" alt="내가 본 영화 이미지 찾기"></a>
                                    <a href="">
                                ...
                                <div>
                                    <a href="#"><img src="../../images/noticePng/notice05.png" alt=""></a>
                                    <a href="">
                                        <p>내 문의 내역</p><span>내 문의를 확인하세요!</span>
                                    </a>
                                </div>
                                <div>
                                    <a href="#"><img src="../../images/noticePng/notice02.png" alt=""></a>
                                ...
                                <div>
                                    <a href="#"><img src="../../images/noticePng/notice04.png" alt=""></a>
                                    <a href="">
                                        <p>개인정보 수정</p><span>내 정보를 수정하세요!</span>
                                    </a>
                                </div>
                                <div>
                                    <a href="#"><img src="" alt="비밀번호 수정 이미지 찾기"></a>
                                    <a href="">
                                        <p>비밀번호 수정</p><span>내 비밀번호를 수정하세요!</span>
                                    </a>
                                </div>
                            </div>
                        </div>
