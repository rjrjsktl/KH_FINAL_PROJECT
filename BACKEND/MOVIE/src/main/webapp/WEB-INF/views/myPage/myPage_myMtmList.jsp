...
<link rel="stylesheet"
	href="${contextPath}/resources/css/myPage/myPage_myMtmList.css">
<link rel="stylesheet"
							...
							<div class="notice-content-wrap">
								...
								<div class="search-area">
									<p>
										내 1:1문의 게시글 총
										<c:choose>
											<c:when test="${not empty mtmUserList.userMtmCount}">
												<span>${mtmUserList.userMtmCount}</span>
											</c:when>
											<c:otherwise>
												<span>0</span>
											</c:otherwise>
								...
								<div class="table-wrap">
									<table>
										...
										<tbody>
											...
											<c:choose>
												<c:when test="${empty mtmUserList.mtmList}">
													<tr class="row">
														<td colspan="3">게시글이 존재하지 않습니다.</td>
													</tr>
												</c:when>
												<c:otherwise>
													<c:forEach var="mtmUserList" items="${mtmUserList.mtmList}"
														varStatus="loop">
									...
									<div class="page_Nation">
										...
										<c:set var="pagination" value="${mtmUserList['pagination']}" />
