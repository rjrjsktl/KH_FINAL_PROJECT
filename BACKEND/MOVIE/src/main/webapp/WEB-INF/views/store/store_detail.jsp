                    ...
                    <main>
                        ...
                        <div>
                            ...
                            <div class="content" style="display: none;">
                                ...
                                &gt; 예매/구매내역에서 확인 가능합니다.<br>- 매점교환권은 롯데시네마 APP [바로팝콘]에서 사용 영화관 및 품목 선택 후, 결제수단에서 '교환권'
                                선택시
                                사용가능합니다.<br>- 영화관 스위트샵(매점) 방문 후, 바코드를 제시하는 방법으로도 사용가능합니다.<br>- 선물한 매점교환권은 문자쿠폰(MMS)으로
                                발송되며, 수신자가
                                롯데시네마 APP에서 비밀번호와 함께 등록하여 사용 가능합니다.<br>- 선물한 상품은 마이시네마 &gt; 예매/구매내역 메뉴에서 30일 내 재발송 1회만
                                가능하며, 받는
