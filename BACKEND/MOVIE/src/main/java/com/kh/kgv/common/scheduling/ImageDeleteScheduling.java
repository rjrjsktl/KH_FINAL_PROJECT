...
//
//	Logger logger =LoggerFactory.getLogger(ImageDeleteScheduling.class);
//	
...
//	
//	// 코딩 순서
//	// 1) BOARD_IMG 에 존재하는 모든 이미지 목록 조회
...
//		
//		// 2) /resources/images/board폴더에 존재하는 모든 이미지 파일 목록 조회
